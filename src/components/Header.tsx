...
export default function HeaderBar(
  ...
  return (
    <header className="relative bg-[#2A0134] lg:bg-white border-b border-[#2A0134]/10 px-6 py-12 lg:py-4 block lg:flex
     items-center justify-between shadow-lg rounded-lg lg:rounded-none  ">
      ...
      <div className=" items-center gap-3 hidden lg:flex">
        ...
        <h1 className="text-lg font-semibold text-white lg:text-[#2A0134]">
          Finance Dashboard
        </h1>
      </div>   
  ...
  <div className="flex flex-col">
    <div className="flex items-center gap-1">
      <span className="text-md font-medium text-white lg:text-[#2A0134]">
 ...
 {showDropdown && (
          <div className="absolute top-14 right-10 w-56  shadow-xl z-50">
          <DropDown
            showLeftImage={true}
